...
public class RobesFiançailles extends JFrame implements ItemListener,ActionListener,WindowListener {
	...
	public RobesFiançailles() {
		...
		robes_fian = new JPanel();
		robes_fian.setLayout(new FlowLayout());
		robes_fian.setBackground(new Color(0xFFf9f3f3));
		mn.selectionImages("select image,id from robes where type='fiançailles'", robes_fian);
		retour = new JButton("Retour");
		robes_fian.add(retour);
		retour.addActionListener(this);


		this.add(robes_fian,BorderLayout.CENTER);
